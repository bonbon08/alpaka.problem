...
def get_ai_return(trolllevel, theme):
    ...
    Endprodunkt, Problem/Fragestellung, Daten&technologien and was fehlt uns create a maximum of 1 sentence for each title keep your answers as short maximum for everythign is 120 words?
